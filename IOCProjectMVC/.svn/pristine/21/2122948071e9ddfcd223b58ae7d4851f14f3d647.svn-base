    ...
    require([
        ...
        function () {
            ...
            if (PropiedadesBiological.numberChart == 0) {
                ...
                var columna = '<td class="col-lg-6"><div id="PieChartBiologicalData' + String(PropiedadesBiological.numberChart) + '"></div></td>';
                ...
                var fila = '<tr id="row' + String(PropiedadesBiological.numberChart) + '" class="row"></tr>';
